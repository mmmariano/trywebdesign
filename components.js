    ...
    <div class="footer-top">
        ...
        <div class="footer-nav-group">
            ...
            <div class="footer-column">
                ...
                <a href="https://www.linkedin.com/in/mateusmariano/" target="_blank">LinkedIn</a>
            </div>
        </div>
    </div>
    <div class="footer-bottom">
        <div class="footer-legal">
            <p>© 2025 EUGÊNCIA TRYWEBDESIGN. Todos os direitos reservados. Mateus M. Mariano</p>
        </div>
...
function setupNavbar() {
    ...
    if (!document.getElementById('whatsapp-fixo')) {
        const div = document.createElement('div');
        div.id = 'whatsapp-fixo';
        div.innerHTML = whatsappFluanteHTML;
